...
<html>
    ...
    <body>
        <form action="ControladorTipoDocumento">   
            <div class="card-header" >
                <h2>Consultar tipo de documento</h2>
            </div>
                ...
                <div class="  form-control">
                    <div class="table-responsive">        
                        <table id="example" class="table "  width="100%">
                            ...
                            <tbody id="">
                                <jsp:useBean id="vdao" class="ModeloDAO.TipoDocumentoDAO" scope="page"  ></jsp:useBean>
                                <%
                                    ResultSet rs = vdao.listartd();
                                    while (rs.next()) {
                                %>
                                <tr>
                                    <td class="text-center"><%=rs.getInt("Id_Tipo_Documento")%></td>
                                    <td class="text-center"><%=rs.getString("Nombre_Tipo_Documento")%></td>
                                    <td class="text-center">
                                        <a title="Editar" class="btn btn-warning" href="ControladorTipoDocumento?accion=editar&id=<%=rs.getInt("Id_Tipo_Documento")%>"><i class="fas  fa-edit" title="Modificar registro"></i></a>
                                        <a title="Eliminar" class="btn btn-danger" href="ControladorTipoDocumento?accion=eliminar&id=<%=rs.getInt("Id_Tipo_Documento")%>"><i class="fas  fa-trash" title="Eliminar registro"></i></a>
                                    </td>
                                </tr>
                                <%
                                    }
