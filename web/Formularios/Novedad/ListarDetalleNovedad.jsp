                    ...
                    <div class="table-responsive">        
                        <table id="example" class="table "  width="100%">
                            ...
                            <tbody id="">
                                ...
                                <%
                                    int id = Integer.parseInt((String) request.getAttribute("idnov"));

                                    ResultSet rs = vdao.listardetallenov(id);
                                    while (rs.next()) {
                                %>
                                <tr>
                                    <td class="text-center"><%=rs.getInt("Id_Detalle_Productosede_Novedad")%></td>
                                    <td class="text-center"><%=rs.getString("Cantidad")%></td>
                                    <td class="text-center"><%=rs.getString("fk_idnovedad")%></td>
