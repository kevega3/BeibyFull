                    ...
                    <table id="example" class="table " width="100%">
                        ...
                        <tbody id="">
                            ...
                            <%
                                ...
                                ResultSet rs = vdao.listardetallecompra(id);
                                while (rs.next()) {
                            %>
                            <tr>
                                <td class="text-center"><%=rs.getInt("Id_Detalleproducto_Idcompra")%></td>
                                <td class="text-center"><%=rs.getString("compra.numero_serie")%></td>
