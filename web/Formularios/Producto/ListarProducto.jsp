                ...
                <div class="  form-control">
                    <div class="table-responsive">        
                        <table id="example" class="table "  width="100%">
                            ...
                            <tbody id="">
                                <jsp:useBean id="vdao" class="ModeloDAO.ProductoDAO" scope="page"  ></jsp:useBean>
                                <%
                                    ResultSet rs = vdao.listarproducto();
                                    while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td class="text-center"><%=rs.getDouble("Valor")%></td>
                                    <td class="text-center"><%=rs.getDouble("Cantidad_en_Existencia")%></td>
                                    <td class="text-center"><%=rs.getString("tipo_producto.Nombre_Tipo_Producto")%></td>
                                    <td class="text-center"><%=rs.getString("marca.Nombre_Marca")%></td>
                                    <td   class="text-center"> 
                                        <a title="Editar" class="btn btn-warning" href=" ControladorProducto?accion=editar&codigo=<%=rs.getInt("codigo")%>"><i   class="fas fa-edit" title="Modificar registro"></i></a>
                                        <a title="Eliminar"class="btn btn-danger" href="ControladorProducto?accion=eliminar&id=<%=rs.getInt("codigo")%>"><i  class="fas fa-trash" title="Eliminar registro"></i></a>
                                    </td>
                                </tr>
                                <%
                                    }
